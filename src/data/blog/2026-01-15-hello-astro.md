...
title: Hello, Astro
slug: 2026-01-15-hello-astro
draft: false
tags:
  - meta
  - source-astro
description: Migrating from Next.js to Astro
---

I made a bunch of big changes to my blog to kick off 2026. I switched to the [Astro](https://astro.build/) framework with the [Astropaper](https://astro.build/themes/details/astropaper/) template and switched hosting providers to Cloudflare Workers (disclosure: I'm currently employed at Cloudflare which recently acquired Astro).

I'm really happy with the update! My blog now has search, a dedicated tags page, better typography, a reading progress bar, and overall better aesthetics. You can find the source code on [GitHub](https://github.com/acviana/cloudflare-astro-blog).
